/****************************************************************************
 * Copyright 2004-2012 James F. Bowring and www.Earth-Time.org
 *
...
namespace Tripoli.earth_time_org
{
    ...
    /// TracerUPbModel is introduced as part of the evolution of UPbRedux.
    /// </summary>
    [Serializable]
    [XmlRootAttribute("TracerUPbModel",
        Namespace = "http://www.earth-time.org",
        IsNullable = true)]
    public class TracerUPbModel : ISerializable
    {

        private static string schemaName = "TracerUPbModelXMLSchema.xsd";
        ...
        {
            XmlSerializer serializer = new XmlSerializer(typeof(TracerUPbModel));
            ...
            contents.Insert(5, "                            " + getTracerSchemaURI() + "\">"); //http://www.earth-time.org/projects/upb/public_data/XSD/TracerUPbModelXMLSchema.xsd\">");
        ...
        public Tripoli.earth_time_org.TracerUPbModel ReadTracer(string filename)
        {
            ...
            catch (Exception eFile)
            {
                ...
                System.Windows.Forms.MessageBox.Show(
                     "File: "
                    + getTracerSchemaURI()
                    + " cannot be reached ... check your Internet connection.\n\nTripoli will attempt to load TracerUPbModel file without validation.",
                    "Tripoli Warning");
                sc = null;
            }
            ...
            return (TracerUPbModel)serializer.Deserialize(reader);
        ...
        protected TracerUPbModel(SerializationInfo si, StreamingContext context)
        {
        ...
        static void Main(string[] args)
        {
            ...
            TracerUPbModel tr = new TracerUPbModel();
            tr.tracerName = "Hell Yes";
            tr.SerializeXMLTracer("Tracer.xml");

            TracerUPbModel tr2 = new TracerUPbModel();
            tr2 = tr2.ReadTracer("Tracer.xml");

            Console.WriteLine("TracerUPbModel read: " + tr2.getNameAndVersion());
        }
    }
