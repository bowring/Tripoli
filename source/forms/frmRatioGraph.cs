...
{
    /// <summary>
    /// Summary description for frmRatioGraph.
    /// </summary>
    public class frmRatioGraph : System.Windows.Forms.Form, IComparable
    {
        ...
        public frmRatioGraph() { }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="ActiveRatios"></param>
        public frmRatioGraph(RawRatio ActiveRatios, string SampleName, double ChauvenetsThreshold)
        {
            GraphIdentity = "RATIO";
